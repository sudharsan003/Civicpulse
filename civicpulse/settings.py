"""
Django settings for civicpulse_project project.
...
ROOT_URLCONF = 'civicpulse_project.urls'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')  # safer
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')  # use env var
